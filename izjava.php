	...
	<body>
			<div class="middle"> <div class="boxx" ><form action="prikazi.php" method="post" style="padding: 5px 5px 40px 5px">
				...
				<div  style="float: left; text-align:center"> 
					<input type="submit" value="ЗАЧУВАЈ ЈА ИЗЈАВАТА" name="izjava"> 
				</div>
				...
				<div style="text-align:center">
					...
					<div style="text-align:left; padding:5px">
						...
						и  единствен матичен број <input type="text" name="embg" size="13" maxlength="13"> изјавувам.
						<textarea rows="15" cols="47" name="text">   </textarea>
						<div style="float: right; padding-right: 25px"; >  
						Поднесител на изјавата <br><input type="text" name="name1" size="13" maxlength="30">
						</div>
