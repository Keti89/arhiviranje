...
<?php
	...
	$re = mysqli_query($sConn,"SELECT * FROM person  WHERE kategorija = 'Drugo' AND idt='1' ORDER BY data_added DESC");
	...
	if($countt>0)
	{
		while($row=mysqli_fetch_array($re))
		{
			...
			$izjavii.="<tr bgcolor=\"white\" style=\"border:1px solid black;\"><td><b>$idk$id_dr</b></td><td><a href ='upload/$NameFile'>$ime</a></td><td><b>$data_added</b></td></tr>";
			//$izjavii.="<br> <a href =\"izjava_prikacena.php?idf=".$row["idf"]."\">$data_added - $idf</a>";
		}
		$izjavii.="</table>";
	}
	else {
		$izjavii="Нема внесено ништо";
	}
?>
